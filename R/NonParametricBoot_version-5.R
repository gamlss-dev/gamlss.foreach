...
################################################################################
################################################################################
# FUNCTION classical Bootstrap 
# m=Mikis revision 27-10-2022
################################################################################
################################################################################
################################################################################
################################################################################
...
names( boot_data) <- names(datA)
  ...
  list(coef=coefAll1(mooo, deviance = TRUE), par=predictAll(mooo, data=boot_data, 
                                  newdata=newdata, output="matrix")) 
    }
##   FOREACH ENDS  
            newB <- length(res)
